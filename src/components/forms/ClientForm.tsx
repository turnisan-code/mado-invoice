    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <select name="tax_treatment" defaultValue={client?.tax_treatment ?? 'at_vat'}
        ...
        <div className="space-y-1.5">
          ...
          <select name="language" defaultValue={client?.language ?? 'de'}
            className="w-full border border-neutral-200 rounded-md px-3 py-1.5 text-sm bg-white focus:outline-none focus:ring-1 focus:ring-neutral-400">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <select name="currency" defaultValue={client?.currency ?? 'EUR'}
            className="w-full border border-neutral-200 rounded-md px-3 py-1.5 text-sm bg-white focus:outline-none focus:ring-1 focus:ring-neutral-400">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Tags (comma separated)" name="tags" defaultValue={client?.tags?.join(', ') ?? ''} />
      </div>
