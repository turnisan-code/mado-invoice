                    ...
                    {editingId === item.id ? (
                      <>
                        ...
                        <td className="px-1 py-1">
                          <select value={draft.unit ?? 'flat'} onChange={e => setDraft(d => ({ ...d, unit: e.target.value as Unit }))} className={SELECT_CLS}>
                            {UNITS.map(u => <option key={u} value={u}>{u}</option>)}
                          </select>
                        </td>
                        <td className="px-1 py-1">
                          <select value={draft.vat_rate ?? 20} onChange={e => setDraft(d => ({ ...d, vat_rate: parseInt(e.target.value) as VatRate }))} className={SELECT_CLS}>
